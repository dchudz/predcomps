...
```{r}
GetSingleInputApcs(function(df) return(df$u * df$v), makeExampleDF(100), u="u", v="v")$Apc.Signed
GetSingleInputApcs(function(df) return(df$u * df$v), makeExampleDF(300), u="u", v="v")$Apc.Signed
```

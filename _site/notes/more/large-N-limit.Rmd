...
```{r}
GetSingleInputPredComps(function(df) return(df$u * df$v), makeExampleDF(100), u="u", v="v")$Apc.Signed
GetSingleInputPredComps(function(df) return(df$u * df$v), makeExampleDF(300), u="u", v="v")$Apc.Signed
```

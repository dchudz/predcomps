...
Notice that for one particular choice of other input values, transitioning from 0 to 1 previous time 30-59 days late leads to a *decrease* in predicted default probability. The [the example](examples-loan-defaults.html) for some thoughts on why this might be.

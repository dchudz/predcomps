...
$$.4 \cdot .5 \cdot .5 \cdot (f(20,3) - f(10, 3)) + 0.1 \cdot .5 \cdot .5 (f(60,7) - f(50,7)) $$

The .5's are the $p(u|v)$'s (and will end up canceling out). (Terms with transition size 0 aren't included.)

The denominator is:

$$.4 \cdot .5 \cdot .5 \cdot (20 - 10) + .1 \cdot .5 \cdot .5 \cdot (60 - 50)$$

The ratio simplifies to:

$$.8 \frac{\delta_u(10 \rightarrow 20, 3, f)}{10} + 0.2 \frac{\delta_u(50 \rightarrow 60, 7, f)}{10} $$
...
APC1 <- .8*(f(20,3) - f(10,3))/10 + .2*(f(60,7) - f(50,7))/10
APC1
```
...
pairsDF[sample(1:nrow(pairsDF), 50), ]
```
